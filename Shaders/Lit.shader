Shader "GRP/Lit"
{
	...
	Subshader
	{
		...
		#pragma multi_comple _ LOD_FADE_CROSSFADE
		...
		Pass
		{
			...
			#pragma multi_comple _ _OUTPUT_NORMALS_ENABLED
			#pragma multi_comple _ _DIRECTIONAL_PCF3 _DIRECTIONAL_PCF5 _DIRECTIONAL_PCF7
			#pragma multi_comple _ _OTHER_PCF3 _OTHER_PCF5 _OTHER_PCF7
			#pragma multi_comple _ _CASCADE_BLEND_SOFT _CASCADE_BLEND_DITHER
			#pragma multi_comple _ _LIGHTS_PER_OBJECT
			#pragma multi_comple _ _CELL_SHADING_ENABLED
		...
		Pass
		{
			...
			HLSLPROGRAM
			#pragma target 3.5
			#pragma multi_comple _ _SHADOWS_CLIP _SHADOWS_DITHER
